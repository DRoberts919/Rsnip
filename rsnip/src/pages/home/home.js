      ...
      <div className="content black-txt">
        ...
        <div className="mw-900">
          ...
          <div className="dark-secondary-text">
            RSnip is an online tool that allows users to create and share small
            snippets of code built in React. Common web solutions shouldn't be
            hard to code. You've already done it once, why do it again? With
            RSnip, you can save your React code as a snippet to view and use
            later.
          </div>
